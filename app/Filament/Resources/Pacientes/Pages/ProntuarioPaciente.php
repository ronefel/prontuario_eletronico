...
class ProntuarioPaciente extends Page
{
    ...
    protected string $view = 'filament.pages.prontuario';
    ...
    public function createAction(): Action
    {
        return Action::make('create')
            ...
            ->size(Size::Small)
            ->modalWidth(AgentHelper::isMobile() ? Width::Screen : Width::SixExtraLarge)
    ...
    public function editAction(): Action
    {
        return Action::make('edit')
            ->schema(self::formFields([Hidden::make('id')]))
            ->fillForm(function (array $arguments) {
                $this->prontuario = Prontuario::find($arguments['prontuario'] ?? null);
