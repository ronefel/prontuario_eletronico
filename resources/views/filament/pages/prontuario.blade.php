        ...
        <div>
            ...
            @php
                ...
                $sortedProntuarios = $sortedDates->flatMap(function ($date) use ($groupedProntuarios) {
                    return $groupedProntuarios[$date]->sortByDesc(function ($prontuario) {
                ...
                $margemSuperior = $settings['margem_superior'] . 'mm';
                $margemInferior = $settings['margem_inferior'] . 'mm';
                $margemEsquerda = $settings['margem_esquerda'] . 'mm';
                $margemDireita = $settings['margem_direita'] . 'mm';
            @endphp
            <div
                style="--margem-superior: {{ $margemSuperior }}; --margem-inferior: {{ $margemInferior }}; --margem-esquerda: {{ $margemEsquerda }}; --margem-direita: {{ $margemDireita }};">
